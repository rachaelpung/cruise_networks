...
paneller=function(row = 1,column=1)
{
  ...
  if(row == 1 & column == 1) {
    ...
    grid.text('B',x=unit(-2.5,'lines'),y=unit(10.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  
  if(row == 1 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
    grid.yaxis(at=seq(0,20,5),label=seq(0,20,5))
    grid.text('C',x=unit(-2.5,'lines'),y=unit(10.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))
  ...
  if(row == 1 & column == 3) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
    ...
    grid.text('D',x=unit(-2.5,'lines'),y=unit(10.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  ...
  if(row ==1 & column ==1){
    ...
    colourbar(x_bottom_left = 1.2, y_bottom_left = -0.18, y_length = 0.035, x_width = 0.2)
  }
...
paneller=function(row = 1,column=1)
{
  ...
  # data
  if(column==1){data = resultsStatic_set_10}
  if(column==2){data = resultsStatic_set_11}
  if(column==3){data = resultsStatic_set_12}
  ...
  # results 1-3
  # if(row == 1 & column == 1) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,20,5),label=seq(0,20,5))
  ...
  # 
  # if(row == 1 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.text('B',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  # 
  # if(row == 1 & column == 3) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,1000,250),label=seq(0,1000,250))
  #   grid.text('C',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  # 
  # if(row == 2 & column == 1) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,50,10),label=seq(0,50,10))
  ...
  # 
  # if(row == 2 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,250,50),label=seq(0,250,50))
  #   grid.text('E',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  # 
  # if(row == 2 & column == 3) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,2000,500),label=seq(0,2000,500))
  ...
  # 
  # if(row == 1 &column == 2) {#grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,350,50),label=seq(0,350,50))
  #   grid.text('B',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  # 
  # if(row == 1 &column == 3) {#grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,2000,500),label=seq(0,2000,500))
  ...
  # 
  # if(row == 2 & column == 1) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,150,25),label=seq(0,150,25))
  #   grid.text('D',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))
  #   grid.text('95th percentile outbreak size',x=unit(-3.5,'lines'),rot=90)}
  # 
  # if(row == 2 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,750,150),label=seq(0,750,150))
  #   grid.text('E',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  # 
  # if(row == 2 & column == 3) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
  #   grid.yaxis(at=seq(0,2500,500),label=seq(0,2500,500))
  #   grid.text('F',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  ...
  if(row == 1 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
    grid.yaxis(at=seq(0,10,2),label=seq(0,10,2))
    grid.text('B',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
  ...
  if(row == 2 & column == 2) {grid.xaxis(at=seq(0,100,25),label=seq(0,100,25))
    grid.yaxis(at=seq(0,25,5),label=seq(0,25,5))
    grid.text('E',x=unit(-2.7,'lines'),y=unit(11.5,'lines'),gp=gpar(fontsize=unit(12,'pt')))}
...
png('figure/simulation_sensitivity_analysis_3_network.png',height=16,width=24,units='cm',res=300,pointsize=10)
