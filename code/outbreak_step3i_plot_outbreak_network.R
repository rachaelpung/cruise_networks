...
# select edgelist
outbreak.edge = edgeListStatic$edgeList.trans.long
...
inches = 0.393701
set.seed(123)
pdf('figure/nature comms pdf/m4a_outbreak_arr.pos_0.96_seed123.pdf',height=24*inches,width=24*inches,pointsize=10)
