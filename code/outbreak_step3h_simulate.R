...
paramList=paramStatic
edgeList=edgeListStatic[['edgeListStatic.trans.long']]

# set the presymtomatic rate and scales for FOI based on type of edges
paramList[,presymrate:=0.25] # 0.25, 0.5
paramList[,edge:='edgeListStatic.trans.long'] # edgeListStatic.trans.long, edgeListStatic.trans.short, edgeListStatic.prob
...
resultsStatic_set_12 = copy(results)
save(resultsStatic_set_12, file = 'github/data/outputs/resultsStatic_set_12.RData')
